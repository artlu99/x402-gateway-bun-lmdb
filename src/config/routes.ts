...
function usdcv2(address: string): TokenConfig {
	return {
		address,
		name: "USDC",
		version: "2",
...
function usdcBridgedStargate(address: string): TokenConfig {
	return {
		address,
