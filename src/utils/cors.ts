...
export const CORS_HEADERS: Record<string, string> = {
  ...
  'Access-Control-Allow-Headers': 'Content-Type, Payment-Signature, X-Payment, X-X402-Payer',
};
...
export function corsResponse(body: string, status: number, extraHeaders?: Record<string, string>): Response {
...
export function corsJsonWithHeaders(data: unknown, status: number, extraHeaders?: Record<string, string>): Response {
